...
LOG_PATH_random="summary_results_fix_offline_v2.txt"
...
#for density_nodes in range(1,2):
	...
	for repetition in range(0,nb_repetition):
		...
		val_std_load_priority[repetition]=float(analyse_std_load[3])
		val_maximum_load_priority[repetition]=float(analyse_maximum_load[3])
		val_clients_deficit_priority[repetition]=float(analyse_clients_deficit[4])

		val_deficit_RSSI[repetition]=float(analyse_deficit[3])
		val_throughput_RSSI[repetition]=float(analyse_throughput[3])
		val_std_load_RSSI[repetition]=float(analyse_std_load[4])
		val_maximum_load_RSSI[repetition]=float(analyse_maximum_load[4])
		val_clients_deficit_RSSI[repetition]=float(analyse_clients_deficit[5])

		val_deficit_FF[repetition]=float(analyse_deficit[4])
		val_throughput_FF[repetition]=float(analyse_throughput[4])
		val_std_load_FF[repetition]=float(analyse_std_load[5])
		val_maximum_load_FF[repetition]=float(analyse_maximum_load[5])
		val_clients_deficit_FF[repetition]=float(analyse_clients_deficit[6])

		val_deficit_LL[repetition]=float(analyse_deficit[5])
		val_throughput_LL[repetition]=float(analyse_throughput[5])
		val_std_load_LL[repetition]=float(analyse_std_load[6])
		val_maximum_load_LL[repetition]=float(analyse_maximum_load[6])
		val_clients_deficit_LL[repetition]=float(analyse_clients_deficit[7])			
